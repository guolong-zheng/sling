...
def main():
    ...
    if not settings.test_mode:
        ...
        incomplete = 0
        if total_loc < stat_locs:
            incomplete = 1
        debug('Number of Interested Locations:' + str(total_loc))
        debug('Number of obtained locations: ' + str(stat_locs))
	...
	print(infile+","+str(stat_locs)+","+str(stat_traces) +
            "," + str(stat_specs) + "," + str(incomplete) +
            "," + str(stat_time)[:4] + "," + str(stat_atom_data) +
